...
with open('mohammed aadil rafiq machine learning.pdf', "rb") as PDFbyte:
    PDFbyte = PDFbyte.read()
with open('Certificates.pdf', "rb") as certificate:
    certificate = certificate.read()
#####################
# Header 
st.write('''
# Mohammed Aadil Rafiq
##### *Resume* 
''')
...
st.info('''
- Pursuing Master in computer Science from german collage iu internation university of applied science
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #16A2CB;">
  <a class="navbar-brand" href="https://www.linkedin.com/in/mhammed-aadil-rafiq-279745246/" target="_blank">Mohammed Aadil Rafiq</a>
...
txt('**Master in computer Science**(Computer Science), *iu internation univercity of applied science*, germany',
'2002-2006')
st.markdown('''
- Percuing
- 2.3 GPA in Data science
- 2022-2024
''')

txt('**Bachelors of Computer Application** (Computer Science), *Shri khandelwal vaishya pg college*, Jaipur',
'1998-2002')
st.markdown('''
- CGPA: `7+`
- 2019-2022.
...
## Skills
''')
txt3('Programming', '`Python`, `Java`, `JavaScript`')
txt3('Data processing/wrangling', '`SQL`, `pandas`, `numpy`')
txt3('Data visualization', '`matplotlib`, `seaborn`, `plotly`, `altair`, `ggplot2`')
txt3('Machine Learning', '`scikit-learn`')
txt3('Deep Learning', '`TensorFlow`')
txt3('Web development', '`Django`,`Flask`, `HTML`, `CSS`')
...
## Social Media
''')
txt2('LinkedIn', 'https://www.linkedin.com/in/mhammed-aadil-rafiq-279745246/')
txt2('GitHub', 'https://github.com/Aadilrafiq008')
